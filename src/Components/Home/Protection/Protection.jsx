    ...
    return (
        ...
        <div className="px-10 py-10 mt-10 md:hidden flex flex-col items-center">
            ...
            <div className='mt-10 md:flex-none flex flex-col items-center'>
                ...
                <p className="text-[20px] text-[#005D2D] mt-5 w-[95%] md:text-left text-center">Our adblocker stops more than pop-ups. It guards you from malware and data profiling, so you can browse threat-free 24/7. All while keeping your data 100% private, even from us!</p>
            </div>
        </div>
        </>
    )
