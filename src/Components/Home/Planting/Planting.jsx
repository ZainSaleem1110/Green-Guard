        ...
        <div className='md:mt-0 mt-10'>
            ...
            <div className="bg-[#007645] lg:flex flex-none justify-between sm:px-20 px-10">
                <div className="lg:w-[500px] lg:mt-[-42%] flex flex-col lg:items-start items-center">
                    ...
                    <h1 className="lg:text-[48px] md:text-[40px] sm:text-[32px] text-[24px] text-[#FFFFDD] font-bold leading-tight lg:mt-0 mt-10 sm:text-left">Make the Planet a Better Place</h1>
                ...
                <div className="lg:w-[568px] lg:mt-[-2%] mt-10 flex flex-col lg:items-start items-center">
                    <h1 className="lg:text-[48px] md:text-[40px] sm:text-[32px] text-[24px] text-[#FFFFDD] font-bold leading-tight sm:text-left">How Are We Planting Trees?</h1>
