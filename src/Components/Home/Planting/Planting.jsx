...
function Planting() {
    return (
        <div>
            <img src={Greenry} alt="" />
            <div className="bg-[#007645] flex justify-between px-20">
                <div className="w-[500px] h-[993px] mt-[-36%] flex flex-col">
                    <img src={PlantingImg} className="h-[100%]" alt="" />
