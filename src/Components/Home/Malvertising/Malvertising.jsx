    ...
    return (
        ...
        <div className="sm:px-10 px-2 py-10 mt-10 md:hidden flex flex-col items-center font-semibold">
            ...
            <div className='mt-10 md:flex-none flex flex-col items-center'>
                <h1 className="lg:text-[48px] md:text-[40px] sm:text-[32px] text-[28px] text-[#005D2D] leading-tight sm:text-left text-center">What is <span className="font-bold">Malvertising?</span></h1>
